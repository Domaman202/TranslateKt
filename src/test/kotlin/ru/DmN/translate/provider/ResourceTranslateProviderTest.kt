...
class ResourceTranslateProviderTest {
    ...
    fun translateFmtOrNullValueTest() {
        val fmt = TestProvider.translateFmtOrNull(ENGLISH, TranslationKey("fmtValue"), Pair("i", 202))
        assertNotNull(fmt)
    ...
    fun translateFmtOrNullValueColorStyleTest() {
        val fmt = TestProvider.translateFmtOrNull(ENGLISH, TranslationKey("fmtColorStyleValue"), Pair("i", 777))
        assertNotNull(fmt)
